...
LOCK TABLES `theAdmin` WRITE;
/*!40000 ALTER TABLE `theAdmin` DISABLE KEYS */;
INSERT INTO `theAdmin` VALUES ('Admin','Admin');
/*!40000 ALTER TABLE `theAdmin` ENABLE KEYS */;
UNLOCK TABLES;
