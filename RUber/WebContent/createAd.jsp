...
<body>
	<%
		try {
			...
			//PreparedStatement ps = con.prepareStatement("create or replace trigger startuptrigger2 after insert on Users for each row begin insert into Stats values(?,?,?,?,?,?,?,?,?); end;");
			...
			if (count != 0) {
				out.print("Sorry, that advertisement already exists.");
			}
			else{
				query = "INSERT INTO AdvertisingStats VALUES(" + adId + ", '" + adName + "', 0, " + value + ")";
				
				stmt.executeUpdate(query);
				out.print("You have successfully created an advertisement!");
