...
<ul>
  ...
  <li><a class="active" href="Offer.jsp">Offer Ride</a></li>
...
<h1><center>Offer Page</center></h1>


									  
<br>
	<form method="post" action="Offer1.jsp">
	<table>
	<tr>    
	...
	<tr>    
	<td>Car</td><td><input type="text" name="car"></td>
	</tr>
	<tr>    
	<td>Seats</td><td><input type="number" min="1" max="5"" name="seats"></td>
	</tr>
	</table>
	<br>
...
<br>
<h2><center>Information on Passengers Requesting Rides</center></h2>
<%
try
{
...
<form method="post" action="deleteRequest.jsp">
<input type ="submit" value="Delete"/>   Delete yourself from the request queue!
</form>
</body>
</HTML>